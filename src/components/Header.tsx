...
export default function Header({ onToggleMenu }: HeaderProps) {
  return (
    <header className="fixed top-0 left-0 w-full flex justify-between items-center px-6 py-4 bg-white z-20 shadow-sm">
      <button onClick={onToggleMenu} aria-label="Abrir menú lateral">
        <Menu size={28} />
      </button>
      <h1 className="text-2xl font-semibold tracking-widest">CUBEL</h1>
